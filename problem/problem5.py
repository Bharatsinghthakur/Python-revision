...
grid1 = [[2, 3, 1],
         [1, 2, 3],
         [3, 1, 2]]
→ True (A grid of size 3: every row and column contains the numbers 1,2,3)

grid2 = [[1, 2, 3],
         [3, 2, 1],
         [3, 1, 2]]
→ False (The first column is missing the value 2. It should contain 1,2 and 3.
         Similarly, the second column is missing the value 3.)

grid3 = [[2, 2, 3],
         [3, 1, 2],
         [2, 3, 1]]
→ False (The first row is missing the value 1. Same for the first column.)

grid4 = [[1]]
→ True (a grid of size one: it contains 1 as the single value)

grid5 = [[-1, -2, -3],
         [-2, -3, -1],
         [-3, -1, -2]]
→ False (The rows and columns need to contain the values 1,2,3 and not -1,-2,-3)
...
grid8 = [[0, 3],
         [3, 0]]
→ False (for a grid of size two, all rows and columns should contain 1 and 2, not 0 and 3)

grid9 = [[0, 1],
         [1, 0]]
→ False (same as above, all rows and columns should contain 1 and 2, not 0 and 1)
...
grid12 = [[-1, -2, 12, 1],
          ...
          [-2, 1, -1, 12],
          [1, 12, -2, -1]]
→ False (all rows and columns should contain the values 1,2,3,4.
...
# Test Cases
grid1 = [[2, 3, 1], [1, 2, 3], [3, 1, 2]]


grid2 = [[1, 2, 3], [3, 2, 1], [3, 1, 2]]

grid3 = [[2, 2, 3], [3, 1, 2], [2, 3, 1]]


grid4 = [[1]]

grid5 = [[-1, -2, -3], [-2, -3, -1], [-3, -1, -2]]


grid6 = [[1, 3, 3], [3, 1, 2], [2, 3, 1]]


grid7 = [[1, 2, 3, 4], [4, 3, 2, 1], [1, 3, 2, 4], [4, 2, 3, 1]]
...
grid10 = [[1, 1, 6], [1, 6, 1], [6, 1, 1]]


grid11 = [[1, 2, 3, 4], [2, 3, 1, 4], [3, 1, 2, 4], [4, 2, 3, 1]]

grid12 = [[-1, -2, 12, 1], [12, -1, 1, -2], [-2, 1, -1, 12], [1, 12, -2, -1]]

grid13 = [[2, 3, 3], [1, 2, 1], [3, 1, 2]]
